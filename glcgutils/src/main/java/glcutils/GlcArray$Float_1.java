...
public class GlcArray$Float_1 {
    int length;
    float[] array;

    public GlcArray$Float_1(int length) {
        this(length, null);
    }

    GlcArray$Float_1(int length, float[] array) {
        this.length = length;
        this.array = array;
    }
     ...
     */
    public final void set(int i, float t) {
        init();
        array[i] = t;
    }
    ...
    public boolean equals(Object obj) {
        ...
        GlcArray$Float_1 other = (GlcArray$Float_1) obj;
