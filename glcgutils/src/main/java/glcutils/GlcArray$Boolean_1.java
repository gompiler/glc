...
public class GlcArray$Boolean_1 {
    int length;
    boolean[] array;

    public GlcArray$Boolean_1(int length) {
        this(length, null);
    }

    GlcArray$Boolean_1(int length, boolean[] array) {
        this.length = length;
        this.array = array;
    }
    ...
    public boolean equals(Object obj) {
        ...
        GlcArray$Boolean_1 other = (GlcArray$Boolean_1) obj;
