...
happyReduction_23 (happy_x_4 `HappyStk`
	...
	happyIn26
		 (Program {package=getInnerString(happy_var_2), topLevels=happy_var_4}
	) `HappyStk` happyRest}}
...
happyReduction_54 (happy_x_4 `HappyStk`
	...
	happyIn40
		 (((getOffset happy_var_1), happy_var_3)
	) `HappyStk` happyRest}}
...
happyReduction_159 happy_x_1
	 =  case happyOutTok happy_x_1 of { happy_var_1 -> 
	happyIn62
		 (Lit (StringLit (StringLiteral (getOffset happy_var_1) Interpreted $ getInnerString happy_var_1))
	)}
...
happyReduction_160 happy_x_1
	 =  case happyOutTok happy_x_1 of { happy_var_1 -> 
	happyIn62
		 (Lit (StringLit (StringLiteral (getOffset happy_var_1) Raw $ getInnerString happy_var_1))
	)}
